...
import br.unisinos.kickoffapp.adapters.TabEnterpriseAdapter;

public class TabEnterpriseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
         ...
         */
        View x =  inflater.inflate(R.layout.fragment_tab_enterprise,null);
         ...
         */
        viewPager.setAdapter(new TabEnterpriseAdapter(getChildFragmentManager()));
        ...
        tabLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                tabLayout.getTabAt(1).setIcon(R.mipmap.ic_query_builder_white_24dp);
                tabLayout.getTabAt(2).setIcon(R.mipmap.ic_notifications_white_24dp);
                /**
                 * Set title initial
                 */
                getActivity().setTitle("Quadras");
                /**
                 * Set color icon on changed tabs
                 */
